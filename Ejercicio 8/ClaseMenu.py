...
class Menu:
    ...
    def opcion8(self,lista,jsonF):
        cuil=str(input('Ingresar cuil:'))
        lista.gastosSueldoPorEmpleado(cuil)
        print('')
    def opcion9(self,lista,jsonF):
        cuil=str(input('Ingresar cuil:'))
        lista.ModificarBasico(cuil)
    def opcion10(self,lista,jsonF):
        cuil=str(input('Ingresar cuil:'))
        p=float(input('Ingresar Nuevo Porcentaje'))
        lista.modificarPorcentajeporcargo(cuil,p)
    def opcion11(self,lista,jsonF):
        cuil=str(input('Ingresar cuil:'))
        p=float(input('Ingresar Nuevo Porcentaje'))
        lista.modificarPorcentajeporcategoria(cuil,p)
    def opcion12(self,lista,jsonF):
        cuil=str(input('Ingresar cuil:'))
        p=float(input('Ingresar Nuevo Importe'))
        lista.modificaImporteExtra()
        print()
    def opcion13(self,lista,jsonF):
        d = lista.toJSON()
